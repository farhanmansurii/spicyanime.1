...
const Animedetails = ({deets}) => {
  ...
  >
    <div className="bg-gradient-to-t from-black to-transparent w-100">
      <div className="flex flex-col md:flex-row items-center  ">
        <div className=" p-2 my-3 mx-6">

          <div className=" w-[233.33px] bg-cover bg-no-repeat h-[350px] " style={{ backgroundImage: `url(${deets.image})` }}>
          </div>
        </div>
