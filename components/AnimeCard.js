  ...
  return (
    <>
      <Link href={`/details?id=${id}`}>
        ...
        >
          <div className=" bg-gradient-to-t  rounded-[8px] from-base-100 justify-between   min-h-full flex flex-col-reverse to-transparent ">
            <div className="flex flex-row justify-between my-3 ">
              <div className="text-primary capitalize text-shadow-xl text-sm lg:text-md  whitespace-pre-wrap  mx-2  line-clamp-3">
                {title}
              </div>
            </div>
          </div>
